...
namespace HomeBudget.Service
{
    public class CheckPointFacade : ICheckPointFacade
    {
        ...
        public CheckPointFacade(BudgetEntities dbContext)
        {
            checkPointServices = new CheckPointServices(dbContext);
        }
        ...
        public decimal SumMoneyOnAccountGroup(int idCheckPoint, int idAccountGroup)
        {
            ...
            decimal sum = listOfChPointEntry.Where(x => x.Account.GroupId == idAccountGroup).Sum(x => x.Amount);
